...
if (isset($_POST["update-drive"])) {
    ...
    $inProcess = mysqli_real_escape_string($conn, $_POST["inProcess"]);
    $job_role =        mysqli_real_escape_string($conn, $_POST["job_role"]);
    $deadline = mysqli_real_escape_string($conn, $_POST["deadline"]);
    $salary = mysqli_real_escape_string($conn, $_POST["salary"]);
    $location =        mysqli_real_escape_string($conn, $_POST["location"]);
    $desc = mysqli_real_escape_string($conn, $_POST["description"]);
    $skills =        mysqli_real_escape_string($conn, $_POST["skillsreq"]);
    $bond = mysqli_real_escape_string($conn, $_POST["bond"]);
    $stipend = mysqli_real_escape_string($conn, $_POST["stipend"]);
    $will_provide_intern = mysqli_real_escape_string($conn, $_POST["willprovideinternship"]);
    $intern_duration = mysqli_real_escape_string($conn, $_POST["internship_duration"]);
    $sscc = mysqli_real_escape_string($conn, $_POST["ssccriteria"]);
    $hscc = mysqli_real_escape_string($conn, $_POST["hsccriteria"]);
    $cpic = mysqli_real_escape_string($conn, $_POST["cpicriteria"]);
    $spic = mysqli_real_escape_string($conn, $_POST["spicriteria"]);
    $abc = mysqli_real_escape_string($conn, $_POST["active_backlog"]);
    $dbc = mysqli_real_escape_string($conn, $_POST["total_backlog"]);
    $no_of_role = mysqli_real_escape_string($conn, $_POST["no_of_job_role"]);
    $deptEligible = array();
    $targetDir = "uploads/";
