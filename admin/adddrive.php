...
if (isset($_POST["add-drive"])) {
    ...
    $sscc = mysqli_real_escape_string($conn, $_POST["sscc"]);
    $hscc = mysqli_real_escape_string($conn, $_POST["hscc"]);
    $cpic = mysqli_real_escape_string($conn, $_POST["cpic"]);
    $spic = mysqli_real_escape_string($conn, $_POST["spic"]);
    $abc = mysqli_real_escape_string($conn, $_POST["abc"]);
    $dbc = mysqli_real_escape_string($conn, $_POST["dbc"]);
