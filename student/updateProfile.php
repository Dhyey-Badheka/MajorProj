...
if (isset($_SESSION["studentUserId"]) && $access == 1) {
    ...
    if (isset($_POST["update-profile"])) {
        ...
        $enro =  mysqli_real_escape_string($conn, $_POST["enro"]);
        $category = mysqli_real_escape_string($conn, $_POST["category"]);
        $pgoal =  mysqli_real_escape_string($conn, $_POST["pgoal"]);
        $pplotno = mysqli_real_escape_string($conn, $_POST["pplotno"]);
        ...
        $pcountry =  mysqli_real_escape_string($conn, $_POST["pcountry"]);
        $splotno = mysqli_real_escape_string($conn, $_POST["splotno"]);
        $scity = mysqli_real_escape_string($conn, $_POST["scity"]);
        $spin =  mysqli_real_escape_string($conn, $_POST["spin"]);
        $sdistrict =  mysqli_real_escape_string($conn, $_POST["sdistrict"]);
        ...
        $spy = mysqli_real_escape_string($conn, $_POST["spy"]);
        $sp =  mysqli_real_escape_string($conn, $_POST["sp"]);
        $spo6 =  mysqli_real_escape_string($conn, $_POST["spo6"]);
        $sboard =  mysqli_real_escape_string($conn, $_POST["sboard"]);
        $ssname =  mysqli_real_escape_string($conn, $_POST["ssname"]);
        $sedug =  mysqli_real_escape_string($conn, $_POST["sedug"]);
        $isdiploma =  mysqli_real_escape_string($conn, $_POST["isdiploma"]);
        $hpy =  mysqli_real_escape_string($conn, $_POST["hpy"]);
        $hppt =  mysqli_real_escape_string($conn, $_POST["hppt"]);
        $hpt =  mysqli_real_escape_string($conn, $_POST["hpt"]);
        $hboard =  mysqli_real_escape_string($conn, $_POST["hboard"]);
        $hto5 =  mysqli_real_escape_string($conn, $_POST["hto5"]);
        $hmtp6 =  mysqli_real_escape_string($conn, $_POST["hmtp6"]);
        $heg =  mysqli_real_escape_string($conn, $_POST["heg"]);
        $hsname = mysqli_real_escape_string($conn, $_POST["hsname"]);
        $dpy =  mysqli_real_escape_string($conn, $_POST["dpy"]);
        $dcgpa =  mysqli_real_escape_string($conn, $_POST["dcgpa"]);
        $dcn =  mysqli_real_escape_string($conn, $_POST["dcn"]);
        $dvms1 = mysqli_real_escape_string($conn, $_POST["dvms1"]);
        $dvms2 = mysqli_real_escape_string($conn, $_POST["dvms2"]);
        $dvms3 =  mysqli_real_escape_string($conn, $_POST["dvms3"]);
        $dvms4 =  mysqli_real_escape_string($conn, $_POST["dvms4"]);
        $dvms5 = mysqli_real_escape_string($conn, $_POST["dvms5"]);
        $dvms6 = mysqli_real_escape_string($conn, $_POST["dvms6"]);
        $dtbl = mysqli_real_escape_string($conn, $_POST["dtbl"]);
        $degp =  mysqli_real_escape_string($conn, $_POST["degp"]);
        $bvms1 = mysqli_real_escape_string($conn, $_POST["bvms1"]);
        $bvms2 =  mysqli_real_escape_string($conn, $_POST["bvms2"]);
        $bvms3 =  mysqli_real_escape_string($conn, $_POST["bvms3"]);
        $bvms4 =  mysqli_real_escape_string($conn, $_POST["bvms4"]);
        $bvms5 =  mysqli_real_escape_string($conn, $_POST["bvms5"]);
        $bvms6 =  mysqli_real_escape_string($conn, $_POST["bvms6"]);
        $bvms7 = mysqli_real_escape_string($conn, $_POST["bvms7"]);
        $bvms8 = mysqli_real_escape_string($conn, $_POST["bvms8"]);
        $bccpi = mysqli_real_escape_string($conn, $_POST["bccpi"]);
        $babl =  mysqli_real_escape_string($conn, $_POST["babl"]);
        $bcbl =  mysqli_real_escape_string($conn, $_POST["bcbl"]);
